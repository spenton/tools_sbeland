...
function expo_fit,x,y,a, fita=fita, tol=tol
    on_error,2      
    cm=check_math(0.,1.)        ; Don't print math error messages.
    n = n_elements(y)       ;# of points.
    c=robust_poly_fit(x,y,1,yf)        ; Do a straight line fit.
    yd=y-yf
    ...
    return,curvefit(x,y,replicate(1.,n),a,sigmaa,funct='exponential',fita=fita, tol=tol, /double) 
end
